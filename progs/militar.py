...
TABLENAME = 'tblMilitar'

class Militar(Individuo):
  def __init__(self, id='', foto='', nim='', patente='', cc='', nome='', apelido='', idade='', IsCosmos = False):
    Individuo.__init__(self, cc, nome, apelido, idade, foto)
    if id == '':
      if IsCosmos:
